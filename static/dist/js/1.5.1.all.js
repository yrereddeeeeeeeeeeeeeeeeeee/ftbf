...
!function (a) {
    ...
    !function () {
        ...
        d.NAME = {
            ...
            composeValue: function (a) {
                return m.compact([a.region_with_type || m.compact([a.region, a.region_type]).join(" "), a.area_with_type || m.compact([a.area_type, a.area]).join(" "), a.city_with_type || m.compact([a.city_type, a.city]).join(" "), a.settlement_with_type || m.compact([a.settlement_type, a.settlement]).join(" "), a.street_with_type || m.compact([a.street_type, a.street]).join(" "), m.compact([a.house_type, a.house, a.block_type, a.block]).join(" "), m.compact([a.flat_type, a.flat]).join(" "), a.postal_box ? "а/я " + a.postal_box : null]).join(", ")
            }
        }, d.PARTY = {
            urlSuffix: "party",
...
function getMyBaloonTemplate()
{
    return ymaps.templateLayoutFactory.createClass(
        ...
        '<p><strong>Город:</strong> {{ properties.city }}</p>' +
        '<p><strong>Адрес:</strong> {{ properties.address }}</p>' +
        '<div class="select-point-holder"><a class="select-map" data-id="{{ properties.id }}"><span class="unselected">Выбрать</span><span class="selected">Выбрано</span></a></div>' +
        '</div>'
    );
}
